  ...
  return (
    <section className="space-y-8">
      <div className="space-y-2">
        <p className="text-xs font-bold uppercase tracking-widest text-calm font-heading">Support & Boundaries</p>
        <h1 className="text-4xl font-extrabold tracking-tight text-ocean sm:text-5xl font-heading">
          ...
          <div className="space-y-5">
            <div className="flex items-start gap-4 rounded-xl border border-coral/30 bg-coral/5 p-5 text-slate-800 transition-all duration-300 hover:border-coral/50 shadow-sm">
              ...
              <div className="space-y-1">
                <h3 className="font-bold text-coral text-base font-heading">Immediate Help Needed?</h3>
            ...
            {resources ? (
              <div className="rounded-xl border border-sky/40 bg-white/40 p-4 transition-all duration-300 hover:bg-white/60">
                <h4 className="text-xs font-bold uppercase tracking-wider text-calm mb-2 font-heading">Your Regional Resources</h4>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-sm">
                  ...
                  <div className="text-ocean font-semibold font-heading flex items-center gap-1.5 bg-sky/50 px-3 py-1.5 rounded-lg border border-sky/30">
          ...
          <ul className="grid gap-3.5 sm:grid-cols-2 lg:grid-cols-1">
            {notFor.map((item) => (
              <li key={item} className="flex items-center gap-3.5 bg-white/40 border border-white/50 rounded-xl px-4 py-3 shadow-sm hover:bg-white/70 transition-all duration-200">
                ...
                <span className="text-sm font-semibold text-slate-700 capitalize tracking-tight font-heading">{item}</span>
              </li>
            ))}
          </ul>
        </Card>
        ...
        <div className="grid items-stretch md:grid-cols-[0.4fr_0.6fr]">
          ...
          <div className="grid gap-6 p-6 md:p-8 sm:grid-cols-2 bg-white/50 backdrop-blur-md">
            <div className="space-y-2 border-b sm:border-b-0 sm:border-r border-slate-100 pb-6 sm:pb-0 sm:pr-6">
              <div className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-sky text-ocean mb-2 font-bold font-heading">✓</div>
              <h2 className="text-lg font-bold text-ocean font-heading font-semibold">What Bingo can help with</h2>
            ...
            <div className="space-y-2 pt-2 sm:pt-0 sm:pl-2">
              <div className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-coral/10 text-coral mb-2 font-bold font-heading">!</div>
              <h2 className="text-lg font-bold text-ocean font-heading font-semibold">When to seek professional care</h2>
              <p className="text-sm leading-relaxed text-slate-600">
