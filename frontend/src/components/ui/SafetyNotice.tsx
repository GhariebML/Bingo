...
export function SafetyNotice({ compact = false }: { compact?: boolean }) {
 ...
 <p>
 Bingoo supports reflection and grounding only. It is not a therapist, doctor, emergency responder, or crisis line. If there is immediate danger, contact local emergency services now.
 </p>
 </div>
 );
}
